...
<div class="card panel">
    ...
    <div class="card-block">
        <div class="attribute">
            ...
            <a href="{{ url('books/import') }}" class="btn btn-primary">Import</a>
            <a href="{{ url('books/export') }}" class="btn btn-primary">Export</a>
...
<!-- modal add data -->
<div class="modal fade modal-1100" id="AddDataModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            $.ajax({
                ...
                success : function(data){
                    ...
                    swal({
                        ...
                        text: "Books data has been updated !",
                        type: 'success',
                    });
                    window.location.reload();
                },
    ...
    $('.edit-action').click(function(e){
        ...
        $.ajax({
            ...
            success : function(result){
                ...
                $('select[name=author_id]').trigger('change').val(result.author_id);
                $('select[name=category_id]').trigger('change').val(result.category_id);
                $('select[name=publisher_id]').trigger('change').val(result.publisher_id);
                $('input[name=publish_place]').val(result.publish_place);
                $('select[name=location_id]').trigger('change').val(result.location_id);
                $('input[name=year]').val(result.year);
                $('select[name=gmd_id]').trigger('change').val(result.gmd_id);
                $('select[name=subject_id]').trigger('change').val(result.subject_id);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        swal({
                            ...
                            text: "Books data has been deleted !",
                            type: 'success',
                        });
                        window.location.reload();
                    },
